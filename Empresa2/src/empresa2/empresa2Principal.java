 ...
 */
public class empresa2Principal {
 ...
 */
    public static void menu(){
        empresa2Class empr = new empresa2Class();
    ...
    public static void insertar(){
        int comple,limit=0;
        if (limit<=10){
        empresa2EmpleadoClass emple = new empresa2EmpleadoClass();
    ...
    */
    public static void listar(){
        for( int i=0;i<listaPersonal.size();i++)
            {
		empresa2EmpleadoClass emple  = (empresa2EmpleadoClass) listaPersonal.get(i);
